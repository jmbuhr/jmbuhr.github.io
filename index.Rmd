...
meta() %>%
  meta_social(
    ...
    url = "https://jmbuhr.de/",
    image = "https://raw.githubusercontent.com/jmbuhr/jmbuhr.github.io/master/assets/img/logo.png",
    image_alt = "the letter j in front of green background",
    og_type = "website",
    og_author = "Jannik Buhr",
    twitter_card_type = "summary",
    twitter_creator = "@jannikbuhr"
  )
```
